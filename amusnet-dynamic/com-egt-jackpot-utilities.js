...
function PopUp(h, w, d) {
	...
	EgtJackpotComponent = function () {
		...
		H.prototype.onRequestComplete = function (e) {
			...
			n.first = !1;
			a = "&#8382;";
			u.push(e.currentLevelI);
			u.push(e.currentLevelII);
			u.push(e.currentLevelIII);
			u.push(e.currentLevelIV);
			...
			this.setPopUpInformation(F, e.largestWinLevelIII, e.largestWinDateLevelIII, e.winsLevelIII, maskUsername(e.lastWinUserLevelIII), e.lastWinDateLevelIII, e.lastWinLevelIII, e.currency);
			this.setPopUpInformation(C, e.largestWinLevelIV, e.largestWinDateLevelIV, e.winsLevelIV, maskUsername(e.lastWinUserLevelIV), e.lastWinDateLevelIV, e.lastWinLevelIV, e.currency);
		...
		H.prototype.processRequestFromServer = function (a) {
			u[0] = a.currentLevelI;
			u[1] = a.currentLevelII;
			u[2] = a.currentLevelIII;
			u[3] = a.currentLevelIV;
			...
			this.setPopUpInformation(F, a.largestWinLevelIII, a.largestWinDateLevelIII, a.winsLevelIII, maskUsername(a.lastWinUserLevelIII), a.lastWinDateLevelIII, a.lastWinLevelIII, a.currency);
			this.setPopUpInformation(C,
				a.largestWinLevelIV, a.largestWinDateLevelIV, a.winsLevelIV, maskUsername(a.lastWinUserLevelIV), a.lastWinDateLevelIV, a.lastWinLevelIV, a.currency);
			for (a = 0; 4 > a; a++)r[a].isPopUpOpen && ("I" == r[a].id && this.updateInformationInPopUp(y), "II" == r[a].id && this.updateInformationInPopUp(N), "III" == r[a].id && this.updateInformationInPopUp(F), "IV" == r[a].id && this.updateInformationInPopUp(C)), this.getDifference(J[a], u[a], a)
		};
				...
				180, V = 180 / Math.PI, ca = {}, T = document, Z = T.createElement("div"), U = T.createElement("img"), S = q._internals = { _specialProps: x }, ea = navigator.userAgent, aa = function () {
					...
					function () {
						...
						return p && (c = -c), "%" === d && -1 !== b.indexOf("border") ? k = c / 100 * (g ? a.clientWidth : a.clientHeight) :
							(h.cssText = "border:0 solid red;position:" + L(a, "position") + ";", "%" !== d && f.appendChild ? h[g ? "borderLeftWidth" : "borderTopWidth"] = c + d : (f = a.parentNode || T.body, h[g ? "width" : "height"] = c + d), f.appendChild(Z), k = parseFloat(Z[g ? "offsetWidth" : "offsetHeight"]), f.removeChild(Z), 0 !== k || e || (k = K(a, b, c, d, !0))), p ? -k : k
					}, W = function (a, b, c) {
